...
namespace BusinessLogicLayer.Migrations
{
    ...
    [Migration("20221019154919_colorProduct")]
    partial class colorProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreLayer.Entities.UserData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ColorProduct", b =>
                {
                    ...
                    b.HasOne("CoreLayer.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CoreLayer.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("CoreLayer.Entities.Product", "CartItemProduct")
                        .WithOne("ProductCartItem")
            ...
            modelBuilder.Entity("CoreLayer.Entities.Order", b =>
                {
                    b.HasOne("CoreLayer.Entities.UserData", "OrderUser")
                        .WithMany("Orders")
